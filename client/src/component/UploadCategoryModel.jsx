...
const UploadCategoryModel = ({close, fetchData}) => {
    ...
    return (
        <section className='fixed top-0 bottom-0 left-0 right-0 p-4 
                ...
                <form className='my-3 grid gap-2' onSubmit={handleSubmit}>
                    <div className='grid gap-1'>
                        ...
                        <input type='text' 
                            ...
                            className='bg-blue-50 p-2 border outline-none
                            border-blue-100  focus-within:border-primary-200 rounded'
                        />  
                    </div>
                    <div className='grid gap-1'>
                        <p>Image</p>
                        <div className='flex gap-4 flex-col lg:flex-row items-center'>
                            ...
                            <label htmlFor='uploadCategoryImage'>
                                ...
                                `}>Upload Image</div>
                                <input disabled={!data.name} onChange={handleUploadCategoryImage} id='uploadCategoryImage' type='file' className='hidden'/>
                            </label>
                        </div>
                    </div>
                    ...
                    <button className={
                        `
                        ${data.name && data.image ? "bg-primary-100 hover:bg-primary-200 hover:text-white" : "bg-slate-300"}
